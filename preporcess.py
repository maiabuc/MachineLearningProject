...
in_dir = "path/to/your_dataset_directory"

# Define the parameters for preprocessing (you can adjust these as needed)
pixdim = (1.5, 1.5, 1.0)
a_min = -200
a_max = 200
spatial_size = [128, 128, 64]

# Call the prepare function to get the DataLoaders
train_loader, test_loader = prepare(in_dir, pixdim, a_min, a_max, spatial_size, cache=True)

# Now you can use train_loader and test_loader for your training and evaluation
